...
export const DF_ROOT_AUTHORITY = "0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff";
...
export function dfDomainSeparator(params: { delegationManager: string; chainId: number | bigint }): string {
...
export function dfTypedDigest(params: { delegationManager: string; chainId: number | bigint; delegationStructHash: string }): string {
